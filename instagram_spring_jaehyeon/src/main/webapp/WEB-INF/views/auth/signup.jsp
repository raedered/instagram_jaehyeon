...
<head>
    ...
    <link rel="stylesheet" href="/jaehyeon/static/css/signup.css">
            ...
            <div class="content-box">
                <div class="item-box">
                    <div class="item-group">
                        ...
                        <form action="/jaehyeon/auth/signup" method="post">
                    ...
                    <div class="item-group">
                        <p>계정이 있으신가요? <a href="/jaehyeon/auth/signin">로그인</a></p>
                    </div>
                    <div class="download-img">
                        <img src="/jaehyeon/static/images/download.png">
                    </div>
                </div>
            </div>
        </main>
    </section>
    <script src="/jaehyeon/static/js/signup.js"></script>
</body>
